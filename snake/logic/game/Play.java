...
public class Play {
    private final SnakeSpace snakeSpace;
    private final Snake snake;
    private final Reaction listener;
    ...
    {
        return snake.getHead().getX() == actualPrize.getX() && snake.getHead().getY() == actualPrize.getY();
    }
    ...
    private String getTime()
    {
        ...
        return "" + second /60 + ":" + (int) timeElapsed%60;
    }
